...
<script>
	...
	export default {
		data(){
			return {
				list:[
					{cls:'',		tit:'微额借款',		con:'金额500、1000元，期限7天、14天、21天',	push:'/loan/micro'},
					{cls:'icon02',	tit:'小额借款',		con:'最高金额5000元，最长期限6个月',		push:'/loan/samll'},
					{cls:'icon03',	tit:'草根福利借款',		con:'最高金额10000元，期限30天',			push:'/loan/large'}
				]
			}
		},
		components:{
