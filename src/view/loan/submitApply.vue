...
<script>
	export default {
	    ...
	    methods :{
	        goApply(){	        	
	        	if(this.data.selectWay == this.defaultSelect )			this.callDialog('请选择还款方式');
	        	else if(this.data.selectAmount == this.defaultSelect)	this.callDialog('请选择借款金额');
	        	else if(this.data.selectLimit == this.defaultSelect)	this.callDialog('请选择借款期限');
