	...
	export default {
	    ...
	    methods :{
	        saveInfo () {
	        	...
	        	else if(this.data.inTime == '')					this.callDialog("入职时间不能为空");
	        	else if(this.data.salary == '')					this.callDialog("月薪不能为空");
	        	else if(this.data.selectProy == this.defVal)	this.callDialog("请选择所在省");
	        	else if(this.data.selectCity == this.defVal)	this.callDialog("请选择所在市");
