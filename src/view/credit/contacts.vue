	...
	export default {
	    ...
	    methods :{
	        saveInfo () {
	        	...
	        	else if(this.data.selectBind1 == this.defBind)			this.callDialog("联系人一 　请选择关系",'text',1600);
	        	else if(checkPhone.test(this.data.conPhone1) == false)	this.callDialog("联系人一 　手机号格式不正确",'text',1600);
	        	else if(checkName.test(this.data.conName2) == false) 	this.callDialog("联系人二 　姓名格式不正确",'text',1600);
	        	else if(this.data.selectBind2 == this.defBind)			this.callDialog("联系人二 　请选择关系",'text',1600);
	        	else if(checkPhone.test(this.data.conPhone2) == false)	this.callDialog("联系人二 　手机号格式不正确",'text',1600);
